  ...
  return (
    ...
    >
      <div className="flex flex-col" style={contentStyle}>
        <div
          className="relative flex flex-col flex-[2] min-h-0 items-center justify-center gap-1 py-2"
        ...
        >
          ...
          <span className="text-[clamp(1.25rem,50cqh,9rem)] font-bold leading-none">
            {score}
          </span>
        </div>
